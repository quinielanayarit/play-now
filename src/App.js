...
const App = (props) => {
  ...
  const noticeCloseDate = "Cierre: Sábado 25 de Noviembre 22:30 HRS"
  ...
  const data = [
    {
      ...
      id: 2,
      localValue: false,
      localTeamIcon: "eng.png",
      localTeamName: "inglaterra",
      drawValue: false,
      visitingTeamIcon: "usa.png",
      visitingTeamName: "estados unidos",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
        {
    ...
    },
    {
      ...
      drawValue: false,
      visitingTeamIcon: "den.png",
      visitingTeamName: "dinamarca",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
