...
const App = (props) => {
  ...
  const subTitle = "Liga MX J4";
  const noticeCloseDate = "Cierre: viernes 27 de Enero 14:30 HRS";
  ...
  const data = [
    {
      ...
      id: 3,
      localValue: false,
      localTeamIcon: "marsella.png",
      localTeamName: "marsella",
      drawValue: false,
      visitingTeamIcon: "monaco.png",
      visitingTeamName: "mónaco",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
