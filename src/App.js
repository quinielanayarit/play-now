...
const App = (props) => {
  ...
  const subTitle = "Liga MX J6";
  const noticeCloseDate = "Cierre: viernes 10 de Febrero 2:30 PM";
  ...
  const data = [
    ...
    },   
    {
      ...
      type: "extra",
      localValue: false,
      localTeamIcon: "leipzig.png",
      localTeamName: "leipzig",
      drawValue: false,
      visitingTeamIcon: "unionberlin.png",
      visitingTeamName: "union berlin",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
