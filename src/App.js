...
const App = (props) => {
  ...
  const subTitle = "JORNADA 7 LIGA MX";
  const noticeCloseDate = "Cierre: viernes 1 de Septiembre 1:00 PM";
  ...
  const data = [
    {
      id: 1,
      localValue: false,
      localTeamIcon: "pgy.png",
      localTeamName: "paraguay",
      drawValue: false,
    ...
    },
    {
      id: 2,
      localValue: false,
      localTeamIcon: "col.png",
      localTeamName: "colombia",
      drawValue: false,
      visitingTeamIcon: "ven.png",
      visitingTeamName: "venezuela",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
    ...
    },
    {
      id: 4,
      localValue: false,
      localTeamIcon: "gua.png",
      localTeamName: "gatemala",
      drawValue: false,
      visitingTeamIcon: "slv.png",
      visitingTeamName: "el salvador",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
        {
    ...
    },
    {
      id: 6,
      localValue: false,
      localTeamIcon: "bra.png",
      localTeamName: "brasil",
      drawValue: false,
      visitingTeamIcon: "bol.png",
      visitingTeamName: "bolivia",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
    ...
    },
    {
      ...
      type: "extra",
      localValue: false,
      localTeamIcon: "tapatio.png",
      localTeamName: "tapatío",
      drawValue: false,
      visitingTeamIcon: "mineros.png",
      visitingTeamName: "mineros",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
