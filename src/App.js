...
const App = (props) => {
  ...
  const noticeCloseDate = "Cierre: viernes 5 de Mayo 13:00 HRS";
  ...
  const data = [
    ...
    },
    {
      ...
      drawValue: false,
      visitingTeamIcon: "arsenal.png",
      visitingTeamName: "arsenal",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
      ...
      drawValue: false,
      visitingTeamIcon: "boca.png",
      visitingTeamName: "boca juniors",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    ...
    },   
    {
      ...
      type: "extra",
      localValue: false,
      localTeamIcon: "westham.png",
      localTeamName: "west ham",
      drawValue: false,
