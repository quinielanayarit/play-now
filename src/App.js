...
const App = (props) => {
  ...
  const noticeCloseDate = "Cierre: viernes 1 de Diciembre 8:00 PM";
  ...
  const data = [
    ...
    },
    {
      id: 4,
      localValue: false,
      localTeamIcon: "feyenoord.png",
      localTeamName: "feyenoord",
      drawValue: false,
      visitingTeamIcon: "psv.png",
      visitingTeamName: "psv",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
        {
      id: 5,
      localValue: false,
      localTeamIcon: "leverkusen.png",
      localTeamName: "leverkusen",
      drawValue: false,
      visitingTeamIcon: "dortmund.png",
      visitingTeamName: "Dortmund",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
