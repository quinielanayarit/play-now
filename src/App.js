...
const App = (props) => {
  ...
  const subTitle = "SEMIFINALES MX";
  const noticeCloseDate = "Cierre: viernes 19 de Mayo 9:00 PM";
  ...
  const data = [
    {
      id: 1,
      localValue: false,
      localTeamIcon: "bmunich.png",
      localTeamName: "bayern munich",
      drawValue: false,
      visitingTeamIcon: "leipzig.png",
      visitingTeamName: "leipzig",
      visitingValue: false,
      ...
      drawValue: false,
      visitingTeamIcon: "rsociedad.png",
      visitingTeamName: "real sociedad",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
    ...
    },
    {
      id: 6,
      localValue: false,
      localTeamIcon: "napoli.png",
      localTeamName: "napoli",
      drawValue: false,
    ...
    },   
    {
      ...
      drawValue: false,
      visitingTeamIcon: "astonvilla.png",
      visitingTeamName: "aston villa",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
