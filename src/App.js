...
const App = (props) => {
  ...
  const subTitle = "PLAY IN";
  const noticeCloseDate = "Cierre: viernes 24 de noviembre 8:00 PM";
  ...
  const data = [
    ...
    },
    {
      id: 8,
      localValue: false,
      localTeamIcon: "girona.png",
      localTeamName: "girona",
      drawValue: false,
