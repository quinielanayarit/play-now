...
const App = (props) => {
  ...
  const subTitle = "JORNADA 1 MX";
  const noticeCloseDate = "Cierre: viernes 30 de Junio 1:00 PM";
  ...
  const data = [
    ...
    },   
    {
      ...
      type: "extra",
      localValue: false,
      localTeamIcon: "saopaulo.png",
      localTeamName: "sao paulo",
      drawValue: false,
      visitingTeamIcon: "fluminense.png",
      visitingTeamName: "fluminense",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
