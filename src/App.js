...
const App = (props) => {
  ...
  const subTitle = "Mix FEM"
  const noticeCloseDate = "Cierre: Viernes 05 de Noviembre 21:30 HRS"
  ...
  const data = [
    {
      id: 1,
      localValue: false,
      localTeamIcon: "fluminense.png",
      localTeamName: "fluminense",
      drawValue: false,
      visitingTeamIcon: "saopaulo.png",
      visitingTeamName: "saopaulo",
      visitingValue: false,
      ...
      localTeamName: "los angeles fc",
      drawValue: false,
      visitingTeamIcon: "phili.png",
      visitingTeamName: "philadelphia",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
        {
    ...
    },
    {
      id: 5,
      localValue: false,
      localTeamIcon: "rsociedad.png",
      localTeamName: "real sociedad",
      drawValue: false,
      visitingTeamIcon: "valencia.png",
      visitingTeamName: "valencia",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
      ...
      drawValue: false,
      visitingTeamIcon: "inter.png",
      visitingTeamName: "inter",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
      ...
      localTeamName: "chivas femenil",
      drawValue: false,
      visitingTeamIcon: "america.png",
      visitingTeamName: "america femenil",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },
    {
      id: 9,
      localValue: false,
      localTeamIcon: "mtyfem.png",
      localTeamName: "monterrey femenil",
      drawValue: false,
      visitingTeamIcon: "tigres.png",
      visitingTeamName: "tigres femenil",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
