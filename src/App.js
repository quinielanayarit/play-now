...
const App = (props) => {
  ...
  const subTitle = "CUARTOS MX";
  const noticeCloseDate = "Cierre: viernes 12 de Mayo 19:00 HRS";
  ...
  const data = [
    ...
    },
    {
      id: 3,
      localValue: false,
      localTeamIcon: "dynamo.png",
      localTeamName: "dynamo",
      drawValue: false,
    ...
    },
    {
      id: 9,
      localValue: false,
      localTeamIcon: "galaxy.png",
      localTeamName: "galaxy",
      drawValue: false,
      visitingTeamIcon: "sanjose.png",
      visitingTeamName: "san jose earthquakes",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
    {
      ...
      drawValue: false,
      visitingTeamIcon: "udinese.png",
      visitingTeamName: "udinese",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
