...
const App = (props) => {
  ...
  const subTitle = "JORNADA 14";
  const noticeCloseDate = "Cierre: viernes 5 de Abril 3:00 PM";
  ...
  const data = [
    ...
    },
    {
      ...
      localTeamName: "athletic",
      drawValue: false,
      visitingTeamIcon: "mallorca.png",
      visitingTeamName: "mallorca",
      visitingValue: false,
      choice: UNSELECTED_SIGN,
    },   
  ];
